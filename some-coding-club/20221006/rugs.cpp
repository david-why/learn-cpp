// https://www.luogu.com.cn/problem/P2121?contestId=86882
// Luogu P2121 拆地毯
#include <bits/stdc++.h>
using namespace std;
...
void join(int i, int j) { pa[find(i)] = j; }
...
int main()
{
    ...
    {
        inint(u, V, w);
        v.pb(make_tuple(u - 1, V - 1, w));
    }

    sort(bte(v), [](const tuple<int, int, int> &a, const tuple<int, int, int> &b)

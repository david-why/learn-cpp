// https://www.luogu.com.cn/problem/P1609?contestId=85850
// Luogu P1609 最小回文数
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    if (s.find_first_not_of('9') == string::npos)
    {
        out("1");
    ...
    string pt = s.substr(0, p);
    string rt = pt;
    reverse(rt.begin(), rt.end());
    string ns = pt + (n % 2 ? rt.substr(1) : rt);
    if (ns > s)
    {
        out(ns, "\n");
        return 0;
